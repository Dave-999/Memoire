...
$A_0$ & Tensile specimen initial minimal area & $[mm^2]$\\
$A_f$ & Tensile specimen minimal area after fracture & $[mm^2]$\\
$d_0$ & Tensile specimen initial minimal diameter & $[mm]$\\ 
$d_f$ & Tensile specimen minimal diameter after fracture& $[mm]$\\ 
$D_a$ & Average particle size & $[\mu m]$\\ 
$E$ & Young modulus & [$GPa$]\\
$E_d$ & Volumetric energy density & $[\frac{J}{mm^3}]$\\
$F$ & Force applied in tensile specimen &$ [N] $\\
$h$ & Hatch space & $[\mu m]$\\
