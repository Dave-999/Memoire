...
The average tensile properties of the as-built specimens are displayed in table \ref{tab:tracMAB}. Detailed information may be consulted in appendice \ref{AppendixAbis}. All data was computed based on the procedures of section \ref{MMTT}.\\
...
No necking phenomena was observed among all tensile tests for AB samples. The Considere criterion for the detection of plastic instability was used. It states that necking starts at $\frac{d\sigma_{true}}{d\epsilon_true}=\sigma$, which is equivalent to $\frac{d\sigma_{eng}}{d\epsilon{eng}}=0$. This condition was not satisfied for any AB engineering stress-strain curve.\\
 
\subsection{Residual stresses}

\subsection{Mechanical properties}

The tensileParler de RAMBERG-OSGOOD
