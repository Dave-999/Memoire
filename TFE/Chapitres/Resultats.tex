...
The composition of new powder measured by ICP spectrometry is shown in table \ref{tab:compoF}. Each mass fraction is vitiated by an error than can go up to 3[\%]. 
 \begin{center}
\begin{table}[ht]
\centering
...
The reiterations of this analysis on the recycled powder used for different batches gave the results from Fig. \ref{fig:Compo}.
