...
When we assume that the residual stresses are uniform, at least at the scale of the hole, when obtain that the as-built sample present a maximal and minimal principal stress respectively of 10 and 1 MPa. For the sample heat-treated at 300$^\circ$C for 2h, they are 43 and 23 MPa. On the other hand, when the assumption that stress varies depending on the depth, the two chosen calculation methods offer different results, available in Fig. \ref{fig:result_rs1}.

\begin{figure}[ht]
	\centering
	\centerline{\includegraphics[scale=0.45]{Images/result_rs1}}
	\decoRule
...
The heat treatment at 150$^\circ$ increased notably both $\sigma_u$ and $\epsilon_f$ compared to the as-built values. However, the heating at 200$^\circ$ caused virtually no change of the ultimate tensile strength, and the fracture strain augmentation was weaker. For HT at 250$^\circ$ and 300$^\circ$, the material softened significantly (with necking appearance); the higher the heating temperature, the bigger the ductility increased and the strength decreased. \\
