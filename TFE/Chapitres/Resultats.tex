...
>>>>>>> ab559e11d2d733eb645721ab5d4cbc1e6b03447f
...
As shown in section \ref{rs_mps}, the as-built samples present an inhomogeneous microstructure separated divided into numerous scan tracks.\\

As-built samples present as expected an inhomogeneous microstructure divided into scan tracks. The 3 different zones can be observed in Fig. \ref{fig:ms_zones}.\\
...
The presence of these 3 zones makes it impossible to give a single representative value to represent the microstructure size. 
