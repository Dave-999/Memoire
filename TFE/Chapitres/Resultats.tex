...
The evolution of powder size distribution during the year, measured without any ultrasonic treatment, is available in figure \ref{fig:granulo}. The mean diameter varied between 31.5 and 36.8 [$\mu$m], corresponding respectively to the last and first samplings. The standard deviation stayed between 14.7 and 16.0 [$\mu$m].\\

\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.8]{Images/Granulo}
	\decoRule
	\caption[Powder size distributions for different batches.]{Powder size distributions for different batches.}
	\label{fig:granulo}
\end{figure}

A general decrease of the mean diameter and a widening of the distribution was observed with respect to time. These trends were inconsistent, as evidenced by the opposite effects measured in February and March.\\
...
\hline 
\hline   
    23/10/2017  &89.2 $\pm 2.67$&0.12 $\pm 0.004$&0.49 $\pm 0.015$&10.2$\pm 0.03$\\
    09/01/2018 & 89.3  $\pm 2.67$& 0.13$\pm 0.004$ &0.48$\pm 0.014$&10.1$\pm 0.03$\\
    12/01/2018 & 89.4  $\pm 2.68$& 0.13$\pm 0.004$ &0.48$\pm 0.014$&10.0$\pm 0.03$\\
    21/02/2018&89.1 $\pm 2.67$&0.19$\pm 0.006$&0.51$\pm 0.015$&10.3$\pm 0.03$\\
    13/03/2018 &89.1  $\pm 2.67$&0.16$\pm 0.005$&0.51$\pm 0.015$&10.1$\pm 0.03$\\    
    17/04/2018& 89.1  $\pm 2.67$&0.14$\pm 0.004$& 0.49 $\pm 0.015$ &10.0$\pm 0.03$\\
    \hline
\end{tabular}}
