...
The traction tests were performed on [Machine?]. The tensile specimens used all originated from batch X200-190417. Details about their geometry and heat treatments can be consulted respectively in sections \ref{MMFPP} and \ref{MMHT}. [Fonctionnement de la machine] [Calcul des charactéristique matériau] \\
