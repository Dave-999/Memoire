...
A tensile test can be used to compute multiple properties. First of all,  the engineering stress ($\sigma_{eng} [MPa]$) and strain  ($\epsilon_{eng} [\%]$) were computed at each time step for every tested samples. The following formulas were used:\\
