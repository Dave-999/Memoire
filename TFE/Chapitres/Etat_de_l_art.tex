...
Secondly, heat-treating at a sufficient temperature can also modify the microstructure of the alloy. This can be directly observed by optical or electronic microscopy. As described in Fig. \ref{fig:microTT}, increasing the temperature allows the diffusion of Si. It is caused by the fast solidification of the alloy during fabrication, which leaves it in a metastable state. Decrease of Si solubility in the Al-phase during cooling and rate of the process traps Si inside the Al solid phase, which becomes super-saturated \cite{PRASHANTH14}. \\
