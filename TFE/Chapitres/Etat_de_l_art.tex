...
Fonctionnement du SLM... The oxygen pressure $p_{O_2}$ should be kept low during the process to prevent the oxidation of the metal. A shielding gas - such as argon - is thus used to fill the build chamber and $p_{O2}$ is monitored at all time.\\ %<1000ppm\\
