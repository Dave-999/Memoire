...
Other laser-related parameters - the spot size and the pulse properties - can also influence the process. Only the laser spot size at the 99\% contour $\phi_{99\%}$ is frequently cited in literature. Its value lies between 100 and 200 [$\mu m$] [Sources?].\\
...
\noindent\makebox[\textwidth]{\begin{tabular}{|c|c|c|c|c|}
    \hline
    Process & Young Modulus [GPa] &$\sigma_u$[MPa]&$\epsilon_f$[\%]&HV \\
\hline
\hline   
    SLM - XY direction & $68 \pm 3$&$391 \pm 6$&$5.55\pm 0.4$&127	\\
    SLM - Z direction & &$396 \pm 8$&$3.47\pm 0.6$&	\\
    \hline
    Conventional cast and aged & 71 &300-317&2.5-3.5&86\\
    As built HPDC & &300-350&3-5&95-105\\
    T6 treated HPDC & &330-365&&130-133\\
    \hline

\end{tabular}}
\caption[Mechanical properties of SLM built parts and cast + aged parts ]{Mechanical properties of SLM built parts and cast + aged parts  (from Kempen et al., 2012)}
\label{tab:Kemp1}
\end{table}
 \end{center}
