...
Results are very sensitive to their variations, which must thus be monitored thoroughly. These reasons complicate the optimisation of the process parameters, still not fully resolved for aluminium alloys.\\%.Les résultats sont très sensibles à leurs variations et il est donc nécessaire de les contrôler méticuleusement. Pour ces raisons, il n'est pas simple d'étudier leurs impacts.\\
\begin{figure}[th]
\centering
...
$$E_d=\frac{P}{v_s h t} $$
where t is the layer thickness and h is the hatch space. As a rule of thumb, $E_d$ should be chosen in the range between 60 and 75 [$\frac{J}{mm^3}$] \parencite{Read150417}.  Almost no studies were carried out to optimize h and t independently. Their values lie generally respectively in the intervals [20 ; 60] [$\mu m$] and [50 ; 200] [$\mu m$].\\
